          ...
          <AnimatePresence mode="wait">
                ...
                <div className="space-y-4">
                  <motion.p variants={itemVariants} className={`text-sm text-center ${isDark ? "text-neutral-500" : "text-neutral-500"}`}>
                    ...
                    <span
                      ...
                      className={`cursor-pointer underline transition-colors ${isDark ? "text-neutral-300 hover:text-white" : "text-neutral-800 hover:text-black"
                        }`}
                    >
                      Create an account
                    </span>
                  ...
                  <motion.p variants={itemVariants} className={`text-[11px] text-center leading-relaxed ${isDark ? "text-neutral-500" : "text-neutral-500"}`}>
                    ...
                    <Link to="/terms" onClick={onClose} className={`underline hover:text-neutral-400 ${isDark ? "text-neutral-300 hover:text-white" : "text-neutral-800 hover:text-black"}`}>Terms</Link>
                    {" "}and{" "}
                    <Link to="/privacy-policy" onClick={onClose} className={`underline hover:text-neutral-400 ${isDark ? "text-neutral-300 hover:text-white" : "text-neutral-800 hover:text-black"}`}>Privacy Policy</Link>.
                  </motion.p>
                </div>
              </motion.div>
            )}
              ...
              >
                ...
                >
                  ...
                  <div className={`flex gap-4`}>
                    ...
                    <label htmlFor="terms" className={`text-sm leading-relaxed font-medium cursor-pointer ${isDark ? "text-neutral-400" : "text-neutral-600"}`}>
                      ...
                      <p className={`text-xs ${isDark ? "text-neutral-500" : "text-neutral-500"}`}>By checking this, you agree to our <Link to="/terms" className={`underline ${isDark ? "text-neutral-300 hover:text-white" : "text-neutral-800 hover:text-black"}`}>Terms of Service</Link> and <Link to="/privacy-policy" className={`underline ${isDark ? "text-neutral-300 hover:text-white" : "text-neutral-800 hover:text-black"}`}>Privacy Policy</Link>.</p>
                    </label>
                  </div>
                ...
                <p className={`text-sm text-center ${isDark ? "text-neutral-500" : "text-neutral-500"}`}>
                  ...
                  <span
                    ...
                    className={`cursor-pointer transition-colors underline ${isDark ? "text-neutral-300 hover:text-white" : "text-neutral-800 hover:text-black"}`}
                  >
                    Sign in
                  </span>
                </p>
            ...
            {step === "email" && (
              ...
              >
                ...
                <p className={`text-sm text-center ${isDark ? "text-[#888888]" : "text-neutral-500"}`}>
