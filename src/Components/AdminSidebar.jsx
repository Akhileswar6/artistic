...
export default function AdminSidebar({ isDark, isCollapsed, setIsCollapsed }) {
  ...
  return (
    ...
    >
      ...
      {/* Logo Area */}
      <div className={`mb-10 px-1 flex items-center gap-1 transition-all duration-500 ${isCollapsed ? "justify-center" : ""}`}>
        <img src="/artisticLogo.png" alt="logo" className="h-12 w-auto object-contain" />
        {!isCollapsed && (
          <div className="animate-in fade-in slide-in-from-left-2 duration-500 relative group -mt-1 -ml-2">
            <span
