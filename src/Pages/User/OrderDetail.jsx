  ...
  return (
    <div className={`min-h-screen pt-24 md:pt-32 pb-24 px-4 md:px-6 transition-colors duration-300 ${isDark ? "bg-[#0a0a0b] text-white" : "bg-[#f8f9fa] text-black"}`} style={{ fontFamily: "Inter, sans-serif" }}>
      <div className="max-w-4xl mx-auto space-y-6 md:space-y-8">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 md:gap-6">
          <div className="flex items-center gap-3 md:gap-4">
            ...
            <div className="overflow-hidden">
              ...
              <p className="text-[10px] md:text-sm mt-1 opacity-50 truncate">#{order._id.toUpperCase()}</p>
            </div>
          </div>
        ...
        <div className={`rounded-2xl md:rounded-[32px] border shadow-xl overflow-hidden ${isDark ? "bg-[#0d0d0d] border-white/10" : "bg-white border-black/5"}`}>
          <div className="p-5 md:p-10 space-y-8 md:space-y-12">
            
            {/* Status Stepper */}
            <div className="space-y-6 md:space-y-8">
              <div className="flex justify-between items-center">
                <h3 className="text-[11px] md:text-[13px] font-bold uppercase tracking-wider opacity-40">Order Progress</h3>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-10">
              <div className="space-y-6 md:space-y-8">
                <div>
                  ...
                  <div className={`p-4 md:p-5 rounded-xl border space-y-3.5 ${isDark ? "bg-white/5 border-white/5" : "bg-gray-50 border-black/5 shadow-sm"}`}>
                    ...
                    <div className="flex justify-between text-[11px] md:text-sm pt-2 border-t border-white/5">
                      <span className="opacity-50">Advance Status</span>
                      <span className={`font-bold uppercase text-[9px] md:text-[10px] px-2 py-0.5 rounded ${order.isAdvancePaid ? "text-emerald-500 bg-emerald-500/10" : "text-amber-500 bg-amber-500/10"}`}>
                ...
                <div>
                  ...
                  <div className={`p-4 md:p-5 rounded-xl border space-y-4 ${isDark ? "bg-white/5 border-white/5" : "bg-gray-50 border-black/5 shadow-sm"}`}>
                    <div className="space-y-1">
                      <p className="text-[10px] md:text-[11px] uppercase tracking-wider opacity-40 font-bold">Recipient</p>
                      <p className="text-xs md:text-sm font-medium">{order.name}</p>
                    </div>
                    <div className="space-y-1">
                      <p className="text-[10px] md:text-[11px] uppercase tracking-wider opacity-40 font-bold">Address</p>
                      <p className="text-xs md:text-sm leading-relaxed">{order.address}</p>
                    </div>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div className="space-y-1">
                        <p className="text-[10px] md:text-[11px] uppercase tracking-wider opacity-40 font-bold">Email</p>
                        <p className="text-xs md:text-sm truncate">{order.email}</p>
                      </div>
                      <div className="space-y-1">
                        <p className="text-[10px] md:text-[11px] uppercase tracking-wider opacity-40 font-bold">Phone</p>
              ...
              <div className="space-y-6 md:space-y-8">
                ...
                <div className={`p-4 md:p-5 rounded-xl border flex items-center justify-between gap-4 ${isDark ? "bg-white/5 border-white/5" : "bg-gray-50 border-black/5"}`}>
                  <div className="space-y-1">
                    <p className="text-[10px] md:text-[11px] uppercase tracking-wider opacity-40 font-bold">Order ID</p>
                    <p className="text-xs md:text-sm font-mono text-blue-400">#{order._id.toUpperCase()}</p>
                  </div>
                  <button
                    onClick={() => {
                    ...
                    {!order.isFullPaid && (
                      <div className="shrink-0 space-y-4 w-full sm:w-auto flex flex-col items-center">
                        <div className={`group relative p-3 rounded-2xl transition-all duration-500 hover:scale-[1.02] shadow-2xl
                          ...
                          <div className="relative w-32 h-32 md:w-40 md:h-40 bg-white flex items-center justify-center overflow-hidden rounded-lg">
                            <img
                              src="/Payment.png"
                              alt="Payment QR Code"
